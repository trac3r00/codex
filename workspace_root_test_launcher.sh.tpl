...
TOTAL_SHARDS="__FIXED_TEST_SHARD_COUNT__"
TOTAL_SHARDS="${TOTAL_SHARDS:-${RULES_RUST_TEST_TOTAL_SHARDS:-${TEST_TOTAL_SHARDS:-}}}"
SHARD_INDEX="__FIXED_TEST_SHARD_INDEX__"
SHARD_INDEX="${SHARD_INDEX:-${RULES_RUST_TEST_SHARD_INDEX:-${TEST_SHARD_INDEX:-}}}"
