...
set "TOTAL_SHARDS=__FIXED_TEST_SHARD_COUNT__"
if not defined TOTAL_SHARDS set "TOTAL_SHARDS=%RULES_RUST_TEST_TOTAL_SHARDS%"
...
set "SHARD_INDEX=__FIXED_TEST_SHARD_INDEX__"
if not defined SHARD_INDEX set "SHARD_INDEX=%RULES_RUST_TEST_SHARD_INDEX%"
